  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-amber-50 to-teal-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Video Library</h1>
          <p className="text-gray-600 mb-6">Browse and watch your collection of {videos.length} videos</p>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-rose-400 focus:outline-none transition-colors"
            />
            {searchTerm && (
              <button
        ...
        {filteredVideos.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredVideos.map((video) => (
              ...
              >
                <div className="aspect-video bg-gradient-to-br from-rose-200 to-teal-200 flex items-center justify-center relative">
                  {video.thumbnail ? (
